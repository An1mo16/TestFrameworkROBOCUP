...
public class Goalie implements ITactic {

	private ArrayList<String> prescribedSituations = new ArrayList<String>(
			Arrays.asList(Ball1R.class.getName(), Ball1L.class.getName(), BallOnGoal.class.getName()));
	private ArrayList<String> initSituations = new ArrayList<String>(
			Arrays.asList(Ball1L.class.getName(), Ball1R.class.getName()));
