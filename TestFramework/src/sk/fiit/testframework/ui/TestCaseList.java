...
import sk.fiit.testframework.trainer.testsuite.testcases.tournament.DtWalkToBallModelSituation;
...
public class TestCaseList {
	...
	public static Thread isRunning = null;
	static {
		testCaseList.add(new TestHolder("DtWalkToBallBypassObstacles", 		new DtWalkToBallBypassObstacles()));
		testCaseList.add(new TestHolder("DtWalkToBallModelSituation", 		new DtWalkToBallModelSituation()));
